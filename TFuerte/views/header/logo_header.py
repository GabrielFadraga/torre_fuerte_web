...
def feria_section() -> rx.Component:
    return rx.vstack(
        # Header de la feria
        rx.box(
            rx.center(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    # Columna para imágenes verticales
                    rx.vstack(
                        rx.hstack(
                            rx.box(
                                rx.image(
                                    ...
                                    _hover={
                                        ...
                                        "box_shadow": "0 12px 35px rgba(0,0,0,0.15)",
                                    }
                                ),
                                flex="1",
                                padding="8px",
        ...
        rx.box(
            ...
            background="white",
            display=["flex", "flex", "none", "none"],  # Solo en móvil
        ),
